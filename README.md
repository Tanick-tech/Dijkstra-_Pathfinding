...
#### 2. **The Algorithm**
The pathfinding logic is implemented with a queu-based search (similar to Breadth-First Search).
...
Although Tkinter is imported, the visualization and interaction are handled entirely by Pygame. The search logic itself is closer to **Breadth‑First Search (BFS)**.  
